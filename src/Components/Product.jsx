function Product({value}){
    return(
        <>
        <div className="relative flex flex-col h-[400px] w-[280px] gap-2 border border-gray-400 rounded-xl overflow-hidden shadow-xl hover:scale-105 duration-300 cursor-pointer hover:border-blue-400 hover:border-3 hover:shadow-2xl">

            <div className="relative w-[100%] h-[70%] overflow-hidden">
                <img src={value.variant[0].imageUrl} alt={value.name} className="h-[100%] w-[100%]" />
            </div>
